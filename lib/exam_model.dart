class Exam {
  ...
  factory Exam.from(dynamic data) {
    ...
    Home home = Home.from(data["home"]);
    Away away = Away.from(data["away"]);
    League league = League.from(data["league"]);
...
class Odd {
  ...
  Odd({this.show, this.goal, this.percent});

  factory Odd.from(dynamic data) {
    return Odd(
...
class League {
  ...
  League(
      {this.leagueId, this.type, this.totalRound, this.currentRound, this.countryId, this.areaId, this.id, this.name, this.mmName, this.shortName, this.subLeagueName, this.currentSeason, this.logo
  ...
  factory League.from(dynamic data) {
    return League(
        ...
        subLeagueName: data['subLeagueName'],
